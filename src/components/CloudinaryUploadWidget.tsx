...
class CloudinaryUploadWidget extends Component {
  componentDidMount() {
    const cloudName = "df2mi0xff"; // replace with your own cloud name
    const uploadPreset = "pokePlant"; // replace with your own upload preset
        ...
        if (!error && result && result.event === "success") {
          ...
          if (image) {
            ...
            fetch(
              ...
              .then((data) => {
                const title = document.getElementById("plantName");
                if (title) {
                  title.textContent = data.bestMatch;
                }
              });
          }
        }
